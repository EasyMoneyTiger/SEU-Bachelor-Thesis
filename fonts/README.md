...
> [!NOTE]
> On some Windows installations, the same fonts may appear under different file names, such as `STKAITI.TTF`, `STFANGSO.TTF`, `simkai.ttf`, or `simfang.ttf`.
> If you already installed the Chinese fonts but the file names differ, either rename them to the names above or use the fallback logic in `seuthesis2026b.cls`.
